...
using Petcu_Cosmina_Lab2.Data;
using Petcu_Cosmina_Lab2.Models;

namespace Petcu_Cosmina_Lab2.Controllers
{
    public class BooksController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("ID,Title,AuthorID,Price,GenreID")] Book book)
        {
            ...
            ViewData["AuthorID"] = new SelectList(_context.Set<Author>(), "ID", "FirstName" + " " + "LastName", book.AuthorID);
            return View(book);
        }
